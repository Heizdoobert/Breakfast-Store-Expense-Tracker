...
class AppProvider {
  static List<SingleChildWidget> providers = [
    ...
    // #########################################################################
    Provider(create: (context) => OwnerFinancialService(context.read<DatabaseService>())),
    Provider(create: (context) => RevenueReportService(context.read<DatabaseService>())),
    Provider(create: (context) => OwnerUserService(context.read<DatabaseService>())),
    Provider(create: (context) => SystemService(context.read<DatabaseService>())),
    ...
    ChangeNotifierProvider(
      create: (context) => RevenueReportController(context.read<RevenueReportService>()),
    ),
    ChangeNotifierProvider(
      create: (context) => FinancialController(context.read<OwnerFinancialService>()),
    ),
    ChangeNotifierProvider(
    ...
    ChangeNotifierProvider(
      create: (context) => UserManagementController(context.read<OwnerUserService>()),
    ),
    ChangeNotifierProvider(
